...
public class LicenseKeyGenerator {
    ...
    public LicenseKeyGenerator(int numberOfSections, int sectionLength, int numberOfCharacter, int numberOfDigit) {
    ...
    public String generate() {
        if (numberOfSections < 2        ||
                ...
                sectionLength < 6       ||
                sectionLength > 10      ||
                numberOfDigit + numberOfCharacter > sectionLength ||
                numberOfDigit < 3       ||
                numberOfDigit > 5       ||
                numberOfCharacter < 3   ||
                numberOfCharacter > 5) {
