...
public class StaticResourceConfig implements WebMvcConfigurer {
  ...
  public void addResourceHandlers(ResourceHandlerRegistry registry) {
    registry
        .addResourceHandler(appConfig.getFrontEnd().getFirstAngularApp().getResourceHandlerPath())
    ...
    registry
        .addResourceHandler(appConfig.getFrontEnd().getSecondAngularApp().getResourceHandlerPath())
  ...
  public void addViewControllers(ViewControllerRegistry registry) {
    ...
    registry
        .addViewController(app1ViewController)
        .setViewName(this.getRedirectViewName(app1ViewController));
    registry
        .addViewController(app2ViewController)
        .setViewName(this.getRedirectViewName(app2ViewController));
    registry
        .addViewController(app1ViewController + DELIMITER)
        .setViewName(this.getForwardViewName(app1ViewName));
    registry
        .addViewController(app2ViewController + DELIMITER)
