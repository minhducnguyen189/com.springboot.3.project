...
class CharacterEncoding {
    ...
    void testLength() {
        ...
        System.out.println(
                "Bytes of “ in US_ASCII: "
                        + Arrays.toString("“".getBytes(StandardCharsets.US_ASCII)));
        System.out.println(
                "Bytes of ” in US_ASCII: "
                        + Arrays.toString("”".getBytes(StandardCharsets.US_ASCII)));
        System.out.println("----------------------------------------------------------");
        ...
        System.out.println(
                "Bytes of “ in ISO_8859_1: "
                        + Arrays.toString("“".getBytes(StandardCharsets.ISO_8859_1)));
        System.out.println(
                "Bytes of ” in ISO_8859_1: "
                        + Arrays.toString("”".getBytes(StandardCharsets.ISO_8859_1)));
        System.out.println("----------------------------------------------------------");
        ...
        System.out.println(
                "Bytes of “ in UTF_16BE: "
                        + Arrays.toString("“".getBytes(StandardCharsets.UTF_16BE)));
        System.out.println(
                "Bytes of ” in UTF_16BE: "
                        + Arrays.toString("”".getBytes(StandardCharsets.UTF_16BE)));
        System.out.println("----------------------------------------------------------");
        ...
        System.out.println(
                "Bytes of “ in UTF_16LE: "
                        + Arrays.toString("“".getBytes(StandardCharsets.UTF_16LE)));
        System.out.println(
                "Bytes of ” in UTF_16LE: "
                        + Arrays.toString("”".getBytes(StandardCharsets.UTF_16LE)));
        System.out.println("----------------------------------------------------------");
